...
*/
#include <FastLED.h> 
#define NUM_LEDS 300        // Enter the number of pixels i.e. No. of LEDS x 3
...
void setup()
{
  ...
  FastLED.addLeds<WS2811, 5, GRB>(leds, 100, 150).setCorrection( TypicalLEDStrip );
  FastLED.addLeds<WS2811, 6, GRB>(leds, 150, 200).setCorrection( TypicalLEDStrip );
  FastLED.addLeds<WS2811, 7, GRB>(leds, 200, 250).setCorrection( TypicalLEDStrip );
  FastLED.addLeds<WS2811, 8, GRB>(leds, 250, NUM_LEDS).setCorrection( TypicalLEDStrip );  
